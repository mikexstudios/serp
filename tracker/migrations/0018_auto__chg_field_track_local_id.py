...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Track.local_id'
        db.alter_column('tracker_track', 'local_id', self.gf('django.db.models.fields.IntegerField')(blank=True))

        # Adding index on 'Track', fields ['local_id']
        db.create_index('tracker_track', ['local_id'])
    
    
    def backwards(self, orm):
        
        # Changing field 'Track.local_id'
        db.alter_column('tracker_track', 'local_id', self.gf('django.db.models.fields.IntegerField')())

        # Removing index on 'Track', fields ['local_id']
        db.delete_index('tracker_track', ['local_id'])
