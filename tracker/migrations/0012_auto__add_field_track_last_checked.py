...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Track.last_checked'
        db.add_column('tracker_track', 'last_checked', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Track.last_checked'
        db.delete_column('tracker_track', 'last_checked')
