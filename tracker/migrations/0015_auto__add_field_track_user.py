...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Track.user'
        db.add_column('tracker_track', 'user', self.gf('django.db.models.fields.related.ForeignKey')(null=True, default=None, to=orm['auth.User']), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Track.user'
        db.delete_column('tracker_track', 'user_id')
