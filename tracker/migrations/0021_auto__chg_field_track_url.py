...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('tracker_track', 'url', self.gf('django.db.models.fields.CharField')(max_length=1000))
    
    
    def backwards(self, orm):
        
        # Changing field 'Track.url'
        db.alter_column('tracker_track', 'url', self.gf('django.db.models.fields.URLField')(max_length=1000))
    ...
    models = {
        ...
        'subscription.plan': {
            ...
            'recurring_unit': ('django.db.models.fields.CharField', [], {'max_length': '1', 'null': 'True', 'blank': 'True'})
        },
        'tracker.check': {
        ...
        'tracker.profile': {
            ...
            'track_increment': ('django.db.models.fields.PositiveIntegerField', [], {'default': '1'}),
        ...
        'tracker.track': {
            ...
            'url_type': ('django.db.models.fields.CharField', [], {'default': "'exact'", 'max_length': '10'}),
